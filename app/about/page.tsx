...
export default function AboutPage() {
  return (
    <section className="max-w-3xl mx-auto py-10 space-y-8">
      <header>
        <h1 className="text-3xl font-bold mb-2 text-[rgb(var(--text))]">About</h1>
      </header>
      ...
      <div>
        ...
        <p className="text-[rgb(var(--body-text))] mb-4 leading-relaxed">The path here wasn’t linear, but it shaped me into a problem-solver who learns quickly, works well with others, and approaches challenges with both creativity and discipline.</p>
        <p className="text-[rgb(var(--body-text))] leading-relaxed">
          When I’m not coding, I enjoy writing articles about web development and personal growth. Sharing my experiences and
            insights with the <span className="text-[rgb(var(--accent))] underline"><Link href="https://x.com/search?q=alege_dev&src=typed_query" target="_blank">tech community</Link></span> is something I find incredibly rewarding.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <ul className="space-y-2 list-disc list-inside text-[rgb(var(--body-text))] marker:text-neutral-500 dark:marker:text-neutral-400">
            ...
            <li className="text-[rgb(var(--accent))] underline"><Link href="https://www.freecodecamp.org/news/javascript-dom/" target="_blank">How the Document Object Model Works in JavaScript</Link></li>
            <li className="text-[rgb(var(--accent))] underline"><Link href="https://www.freecodecamp.org/news/redux-and-redux-toolkit-for-beginners/" target="_blank">How to Use Redux and Redux Toolkit – Tutorial for Beginners</Link></li>
        </ul>
      </div>
            <div>

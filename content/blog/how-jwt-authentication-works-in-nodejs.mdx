...
date: "2026-07-29"
summary: "Every request starts with the server forgetting who you are. Here’s how JWT gives Node.js a way to remember you without storing a session for every user."
tags:
  - nodejs
  - authentication
  - jwt
...
But here's the surprising part: each request is treated as brand-new. 

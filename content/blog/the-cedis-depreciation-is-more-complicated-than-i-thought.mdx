...
image: "/images/cedi_depreciation_cycle.webp"
tags:
  - ghana
  - cedi
  - bank of ghana
...
Recently, I watched a video on YouTube by Shaunn Armah titled **Accra's traffic problem explained**. A part of that video did a really good job at pointing out a lot of inconsistencies in the government's efforts to curb traffic in Accra, and it weirdly got me thinking about how quick we are to blame the government for things without really understanding what's going on behind the scenes.
...
![Diagram showing foreign currency flowing into and out of Ghana through exports and imports](/images/money_flow_diagram.webp)
...
![Forex bureau signboard in Kumasi where people exchange Ghana cedis for foreign currency](/images/forex-bureau-2.webp)
...
So that means there will be fewer dollars on the market that you can actually buy at the normal price, and when that happens, the price of dollars starts going up.
...
The laptop's price didn't change. The Cedi just simply became weaker against the dollar.
...
It's not just business owners who think this way. Big companies, banks and investors do the same thing. When they see the Cedi is about to depreciate, they move some of their money into dollars.
...
![Diagram explaining the cycle of rising dollar demand and Ghana cedi depreciation](/images/cedi_depreciation_cycle.webp)
...
If everyone does it at the same time, the rush itself will make the fuel available in the country become very low. And that can end up pushing the fuel price even higher than it was initially expected to go.
...
But the thing is, when we receive foreign currency, we don't spend all of it immediately. The Bank of Ghana keeps some of it aside and saves it up for emergency use. That saved-up foreign currency is called a **reserve**.
...
So it's clear that reserves can run out. But running out of dollars isn't even the biggest problem the Bank of Ghana faces.

---
title: "I Built a Movie App to Understand Next.js"
date: "2025-11-21"
summary: "React gave me a way to build interfaces, but I kept reaching for more tools. This is how I learned to use Next.js to build a complete movie app."
tags:
  - Next.js
  - React
...
React Router, Axios, Vite/Webpack, server frameworks, SSR tools, and more. Managing all of this yourself quickly
becomes complicated and makes your code harder to maintain.
...
and backend logic, all in one environment and already configured for you. Instead of managing a collection of separate libraries

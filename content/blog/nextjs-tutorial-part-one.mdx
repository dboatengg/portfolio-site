...
```jsx
<li key={movie.id} className="bg-white rounded-lg shadow-sm border overflow-hidden">
...
I'm Dickson, a software developer who enjoys teaching practical, beginner-friendly concepts to help developers build real-world applications. Thanks for following along and happy coding!
    ...
    return (
      <div className="not-prose my-10 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-6">
        <svg viewBox="0 0 680 420" className="w-full h-auto">
          ...
          <text x="580" y="95" textAnchor="middle" dominantBaseline="central" className="fill-emerald-600 dark:fill-emerald-400 text-xs">records: 8842 ✓</text>
          ...
          {/* Server B */}
          <rect x="500" y="280" width="160" height="90" rx="12" className="fill-red-50 dark:fill-red-900/40 stroke-red-500" strokeWidth="0.5" />
          <text x="580" y="305" textAnchor="middle" dominantBaseline="central" className="fill-red-700 dark:fill-red-300 text-sm font-medium">Server B</text>
          <text x="580" y="325" textAnchor="middle" dominantBaseline="central" className="fill-red-600 dark:fill-red-400 text-xs">records: none</text>
          <text x="580" y="343" textAnchor="middle" dominantBaseline="central" className="fill-red-600 dark:fill-red-400 text-xs">{"doesn't know you"}</text>
          ...
          <text x="400" y="140" textAnchor="middle" className="fill-zinc-500 dark:fill-zinc-400 text-xs">request 1 (login)</text>
